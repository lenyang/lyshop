...
class Menu
{
    ...
    public function __construct()
    {
        ...
        '/distribution/dispro_list'=>array('name'=>'分销商品管理','parent'=>'product'),
        '/distribution/dispro_edit'=>array('name'=>'分销商品编辑','parent'=>'product'),
        '/distribution/level_list'=>array('name'=>'分销等级管理','parent'=>'level'),
        '/distribution/level_edit'=>array('name'=>'分销等级编辑','parent'=>'level'),
        '/distribution/rebate_list'=>array('name'=>'分销返利管理','parent'=>'rebate'),
        '/distribution/disorder_list'=>array('name'=>'分销订单管理','parent'=>'disorder'),
        //'/distribution/diswithdraw_list'=>array('name'=>'分销提现管理','parent'=>'rebate'),
        '/distribution/rebate_set'=>array('name'=>'分销返利设置','parent'=>'rebate'),
        );
        //分组菜单
        $subMenu = array(
        ...
        'disorder'=>array('name'=>'分销订单管理','parent'=>'distribution'),
